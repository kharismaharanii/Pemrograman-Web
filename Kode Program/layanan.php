...
<html lang="en">
  ...
  <body>
    ...
    <div class="row">
        <div class="col">
        <img src="img/undraw_team_spirit_hrr4.svg" style="padding-top: 3" width="478" height="478">
        </div>
        <div class="col">
        <h2 style="color: green; margin: 35px 0 25px 0; font-family: Perpetua; font-size:50px">Ini loh layanan E-Math!</h2>
        <p>E-Math merupakan layanan penyedia pembelajaran jenjang SMP<p>
        <p>Keuntungan gabung bersama kami : <p>
        <div style="margin-left: 25px;">
            <p>1. Membayar sekali seumur hidup<p>
            <p>2. Akses modul selamanya<p>
            <p>3. Konsultasi di grup diskusi<p>
            <p>4. Memiliki banyak relasi<p>
        </div>
        <p>Segera daftarkan dirimu ya!<p>
    </div>
