...
include ('koneksi.php');
    ...
    {
        $simpan = mysqli_query($koneksi, "INSERT INTO pelajar (username, password, nomortelegram)
        ...
        if($simpan)
        {
            echo "<script>
                ...
                document.location='tambahdatapelajar.php';
                </script>";
        }
        else
        {
  ...
  <body>
    <nav class="navbar navbar-expand-lg bg-dark fixed-top">
      <a class="navbar-brand text-white p-2"><b>ADMINISTRATOR</b></a>
        ...
        <h4>Tambah Data Pelajar</h4>
        <hr class = bg-secondary>
        <div class="card-body">
            <form method="post">
                <div class="form-grup mb-3">
                    <label>Nama Pengguna</label>
                    <input type="text" name="namapengguna" class="form-control" placeholder="Masukkan nama pengguna" autocomplete="off" required>
                </div>
                <div class="form-grup mb-3">
                    <label>Kata Sandi</label>
                    <input type="text" name="password" class="form-control" placeholder="Masukkan kata sandi" autocomplete="off" required>
                </div>
                <div class="form-grup mb-3">
                    <label>Nomor Telegram</label>
                    <input type="number" name="nomortelegram" class="form-control" placeholder="Masukkan nomor telegram" autocomplete="off" required>
                </div>
